...
#ifndef STUFF_VALUE_CHARACTER
#define STUFF_VALUE_CHARACTER

#include <value/value.h>

class Value_Character : public Value {
    public:
        ...
        VALUE_SUBCLASS(ValueType::CHARACTER, Value);
    private:
        char32_t mValue;
};
